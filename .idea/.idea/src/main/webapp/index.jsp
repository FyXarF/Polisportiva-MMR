...
<head>
    ...
    <style>
        ...
        .container{background-color: #FFE4E1;
        ...
        .product-card .button .button-layer{
            ...
            width: 300%;
            left: -100%;
            background-image: linear-gradient(135deg, #abcdef, #82bcf6, #68aaf8, #107eef);
...
<div class="row">
    ...
    <div class="demo coursemeal">
        ...
        <div class="coursemeal__div">
            ...
            <div class="coursemeal-info">
                <a href="views/ShowProducts.jsp?tipologia=Dolci+delle+feste" class="coursemeal-info__link">DOLCI DELLE FESTE</a>
            </div>
        </div>
